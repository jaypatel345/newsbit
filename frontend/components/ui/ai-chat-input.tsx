      ...
      <div
        ...
        >
          ...
          <div
            ...
            className={cn(
              "relative w-full bg-[#F0F0EB] backdrop-blur-xl backdrop-saturate-150 border border-gray-200 focus-within:border-ring/40 focus-within:ring-1 focus-within:ring-ring/20 z-10",

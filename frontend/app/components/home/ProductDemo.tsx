    ...
    <section className="py-24 bg-white">
      <div className="max-w-6xl mx-auto px-6 sm:px-8">
        ...
        <div className="flex flex-wrap justify-center mb-10">
          <div className="inline-flex p-2 bg-gray-100 rounded-3xl border border-gray-200">
        ...
        <div className="relative">
          ...
          <div className="bg-linear-to-br from-blue-50 to-indigo-50 rounded-3xl p-8 border border-blue-100 shadow-sm h-125 overflow-hidden">
          ...
          <div className="absolute top-1/2 right-0 -translate-y-1/2 bg-white rounded-2xl p-5 border border-gray-200 shadow-lg w-xs h-50 translate-x-1/2">

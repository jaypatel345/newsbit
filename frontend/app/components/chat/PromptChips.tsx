    ...
    <div className="grid w-full grid-cols-1 gap-2 sm:grid-cols-2 sm:gap-3">
      {STARTERS.map((starter) => (
        <button
          ...
          className="group relative overflow-hidden rounded-xl border border-gray-200 bg-white p-4 text-left transition-colors duration-200 hover:border-[#8A6A3F]/40 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#8A6A3F]/30 cursor-pointer"
        >

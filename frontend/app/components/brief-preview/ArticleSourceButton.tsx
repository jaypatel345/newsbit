...
export default function ArticleSourceButton({ articleUrl, sourceName, showText = true }: ArticleSourceButtonProps) {
  ...
  return (
    <a
      ...
      className="inline-flex items-center gap-1 px-1.5 py-0.5 bg-gray-100 hover:bg-gray-200 rounded-md transition-colors text-[10px] font-medium text-gray-700 mt-1"
    >
      <img
        src={faviconUrl}
        alt={sourceName}

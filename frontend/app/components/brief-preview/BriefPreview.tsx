      ...
      <div className="bg-white border border-gray-200 rounded-[2.5rem] p-6">
        ...
        <ul className="text-gray-700 text-sm leading-relaxed mb-6 space-y-2.5">
          <li className="flex items-start gap-3">
            ...
            <span>Markets climbed while AI and global politics dominated today&apos;s biggest headlines.</span>
          </li>
          <li className="flex items-start gap-3">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <span>Tech innovation and economic shifts shaped the narrative across major sectors.</span>
          </li>
          <li className="flex items-start gap-3">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <span>Climate initiatives gained momentum as...</span>
          </li>
        </ul>
        ...
        <div className="flex items-center justify-between pt-4 border-t border-gray-100">
          <div className="flex items-center gap-3 text-xs text-gray-500">
            <span className="font-medium text-gray-700">7 stories</span>
            <span>•</span>

      ...
      <main className="max-w-3xl mx-auto px-6 sm:px-8 py-20">
        ...
        <section className="border-t border-gray-200 pt-12 mb-16">
          ...
          <div className="flex gap-4">
            <a
              ...
              className="inline-flex items-center gap-2 px-4 py-2 border border-gray-200 rounded-lg hover:border-gray-300 hover:bg-stone-50 transition-colors text-gray-700"
            >
        ...
        <section className="border-t border-gray-200 pt-12">
          ...
          <div className="flex gap-4">
            ...
            <Link
              href="/report"
              className="inline-flex items-center gap-2 px-6 py-3 border border-gray-200 text-gray-700 rounded-xl font-medium hover:border-gray-300 hover:bg-stone-50 transition-colors"
            >
              Report an Issue
            </Link>
          </div>
